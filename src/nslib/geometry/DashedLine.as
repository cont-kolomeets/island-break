...
package nslib.geometry
{
	...
	public class DashedLine extends NSSprite
	{
		private var lengthsArray:Array = null; // array of dash and gap lengths (dash,gap,dash,gap....)
		...
		private var curIndex:int = 0; // current index in the length array, so we know which dash or gap to draw
